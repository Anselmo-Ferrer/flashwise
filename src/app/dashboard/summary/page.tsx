      ...
      <div className='w-full flex bg-white items-center justify-between p-6 rounded-2xl mb-10'>
        ...
        <div className='flex items-center gap-3'>
          ...
          <button
            ...
            className='bg-[#FFF7E8] cursor-pointer transition-colors duration-200 ease-in-out hover:bg-[#FFE0A7] w-[200px] flex items-center gap-2 py-3 px-4 rounded-xl text-[#734A00]'
          >
